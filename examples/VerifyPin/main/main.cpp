 ...
 *
 * Each iteration establishes the secure channel and submits the PIN via
 * @ref CryptnoxWallet::verifyPin.  Halts permanently on rejection to
 * protect the card's retry counter.
 *
 ...
 * bus and PN532 reader, then enters @ref run_verify_pin_loop.
 */
